...
(() => {
  ...
  probe('h1', '.featured__title');
  probe('eyebrow', '.featured__eyebrow');
  probe('bookFace', '.featured__object .book__face');
  probe('bookTitle', '.featured__object .book__title');
  probe('entryTitle', '.entry__title');
