...
export const DICT = {
  el: {
    ...
    cookieHeading: 'Cookies',
    cookieMessage:
      'Αυτός ο ιστότοπος χρησιμοποιεί μόνο ό,τι είναι απαραίτητο για να λειτουργήσει, και προαιρετικά, ανώνυμα στατιστικά επισκεψιμότητας αν το επιτρέψετε.',
    cookieLearnMore: 'Πολιτική απορρήτου',
    cookieAccept: 'Αποδοχή',
    cookieDecline: 'Απόρριψη',
    notFoundEyebrow: 'Σελίδα 404',
    notFoundTitle: 'Αυτή η σελίδα δεν βρέθηκε',
    notFoundBody:
      'Ο τίτλος που ψάχνετε δεν υπάρχει, ή έχει μετακινηθεί. Ο κατάλογος στέκεται εκεί που πάντα ήταν.',
    notFoundCta: 'Πίσω στα έργα',
  },
};
